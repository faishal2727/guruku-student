...
class CardWishlist extends StatelessWidget {
  final List<Wishlist> teachers;
  const CardWishlist({super.key, required this.teachers});
                  ...
                  Stack(
                    children: [
                      Container(
                        ...
                        child: teacher.teacher.picture != null
                            ? ClipRRect(
                                borderRadius: BorderRadius.circular(12),
                                child: CachedNetworkImage(
                                  imageUrl: teacher.teacher.picture!,
                                  fit: BoxFit.fill,
