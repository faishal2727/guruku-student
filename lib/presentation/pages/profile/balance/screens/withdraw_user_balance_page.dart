...
import 'package:guruku_student/presentation/pages/profile/balance/widgets/withdraw_user_content.dart';
import 'package:lottie/lottie.dart';

class WithdrawUserBalancePage extends StatefulWidget {
  static const ROUTE_NAME = "/wd-user-page";

  const WithdrawUserBalancePage({super.key});

  @override
  State<WithdrawUserBalancePage> createState() => _WithdrawUserBalancePageState();
}

class _WithdrawUserBalancePageState extends State<WithdrawUserBalancePage> {
