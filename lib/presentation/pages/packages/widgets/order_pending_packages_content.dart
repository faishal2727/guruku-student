...
class OrderPendingPackagesContent extends StatefulWidget {
  final DetailHistoryOrderPackage dataHistoryOrder;
  const OrderPendingPackagesContent({
    super.key,
    required this.dataHistoryOrder,
  });

  @override
  State<OrderPendingPackagesContent> createState() => _OrderPendingPackagesContentState();
}

class _OrderPendingPackagesContentState extends State<OrderPendingPackagesContent> {
