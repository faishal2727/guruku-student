...
import 'package:guruku_student/presentation/pages/teacher/pages/history_order/widgets/detail_hadir_content_page.dart';
import 'package:lottie/lottie.dart';


class DetailHadirPage extends StatefulWidget {
  static const ROUTE_NAME = '/order-hadir-page';
  final int id;

  const DetailHadirPage({
    super.key,
    required this.id,
  });

  @override
  State<DetailHadirPage> createState() => _DetailHadirPageState();
}

class _DetailHadirPageState extends State<DetailHadirPage> {
      ...
      body: BlocBuilder<DetailOrderBloc, DetailOrderState>(
        builder: (context, state) {
          if (state is DetailOrderLoading) {
            ...
            return DetailHadirContentPage(dataHistoryOrder: order);
