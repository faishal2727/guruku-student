...
class CardSuccessPackagesTeacher extends StatelessWidget {
  final DataHistoryOrderPackagesUye dataHistoryOrder;

  const CardSuccessPackagesTeacher({
    super.key,
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.pushNamed(
          context,
          OrderDetailSuccessPage.ROUTE_NAME,
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(dataHistoryOrder.paymentStatus!,
