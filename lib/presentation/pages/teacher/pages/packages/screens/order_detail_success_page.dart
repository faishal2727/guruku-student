...
import 'package:guruku_student/presentation/pages/teacher/pages/packages/widgets/detail_content_ut.dart';
import 'package:lottie/lottie.dart';

class OrderDetailSuccessPage extends StatefulWidget {
  static const ROUTE_NAME = '/order-success-page-uy';
  final int id;

  const OrderDetailSuccessPage({
    super.key,
    required this.id,
  });

  @override
  State<OrderDetailSuccessPage> createState() => _OrderDetailSuccessPageState();
}

class _OrderDetailSuccessPageState extends State<OrderDetailSuccessPage> {
          ...
          builder: (context, state) {
            if (state is DetailOrderPackagesLoading) {
              ...
              return SingleChildScrollView(
                ...
                child: DetailContentUt(dataHistoryOrder: order),
              );
