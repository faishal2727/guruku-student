...
import 'package:guruku_student/presentation/pages/teacher/pages/add_teacher/widgets/education_level_input.dart';
...
class _TeacherPageState extends State<TeacherPage> {
  ...
  late List<String> _selectCategory;
  ...
  void initState() {
    ...
    _selectCategory = widget.data.typeTeaching ?? ['MATEMATIKA'];
    _selectedLevels = widget.data.skill ?? ['SD'];
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      CategoryInputWidget(
                        initialLevels: _selectCategory,
                        onChanged: (List<String> cat) {
                          setState(() {
                            _selectCategory = cat;
                          });
                        },
                      ),
                      EducationLevelInputWidget(
                        initialLevels: _selectedLevels,
                        onChanged: (List<String> levels) {
                          setState(() {
