                    ...
                    builder: (context, state) {
                      if (state is TeacherLoading) {
                        ...
                        if (nearbyTeachers.isEmpty) {
                          // Jika tidak ada guru terdekat ditemukan, tampilkan pesan yang sesuai
                          return const EmptySection();
                        } else {
                          // Jika ada guru terdekat yang ditemukan, tampilkan widget NearbyTeachersListWidget
                          return NearbyTeachersListWidget(
                        ...
                        // Tampilkan pesan yang sesuai jika tidak ada data guru terdekat yang ditemukan
                        return const Center(
                          child: Text(
                        ...
                        // Tampilkan pesan umum jika terjadi kesalahan dalam mengambil data
                        return const Center(
